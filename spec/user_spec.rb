...
describe User do
    ...
    describe '::find_by_id' do
        it 'return an instance of the user class' do
        ...
        it 'only looks fo the first row in the users table' do
    ...
    describe '::find_by_name' do
        it 'returns an instance of the user class' do
            reply = described_class.find_by_name("John", "Spartan")
            expect(reply).to be_kind_of(described_class)
        end

        it 'returns the correct fname and lname' do
            reply = described_class.find_by_name("Rocky", "Balboa")
            expect(reply.fname).to eq("Rocky")
            expect(reply.lname).to eq("Balboa")
        end
    end
